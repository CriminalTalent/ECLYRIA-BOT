...
class MarshmallowCommand
  POSITIVE_EVENTS = [
    { text: "인센디오로 완벽하게 노릇노릇 구웠어요!", reward: 4 },
    { text: "겉은 바삭, 속은 쫀득해요. 최고!", reward: 5 },
    { text: "마시멜로우가 황금빛으로 빛나요!", reward: 3 },
    { text: "기숙사 친구들이 맛있다고 칭찬했어요!", reward: 3 },
    { text: "초콜릿 개구리와 함께 먹으니 환상이에요!", reward: 4 },
    { text: "한 입 베어물자 달콤함이 퍼져요!", reward: 2 },
    { text: "호그와트 비스킷에 끼워먹으니 더 맛있어요!", reward: 3 },
    { text: "기숙사 마시멜로우 굽기 대회에서 1등했어요!", reward: 6 },
    { text: "마법 불꽃에 살짝 그을린 향이 좋아요!", reward: 2 },
    { text: "여러 개 한꺼번에 구웠어요. 대박!", reward: 5 },
    { text: "친구들과 나눠먹으니 더 맛있어요!", reward: 3 },
    { text: "적당한 온도로 천천히 구웠어요!", reward: 4 },
    { text: "달콤한 향이 휴게실에 퍼져요!", reward: 2 },
    { text: "지팡이에 예쁘게 꽂혀서 먹기 좋아요!", reward: 2 },
    { text: "겨울밤에 먹는 마시멜로우는 최고예요!", reward: 3 },
    { text: "마시멜로우가 빵빵하게 부풀었어요!", reward: 2 },
    { text: "구운 마시멜로우로 핫 버터비어를 만들었어요!", reward: 4 },
  ...
  NEGATIVE_EVENTS = [
    { text: "인센디오가 너무 강해서 새까맣게 타버렸어요!", loss: 3 },
    { text: "난로에 떨어뜨렸어요. 아까워요!", loss: 4 },
    { text: "녹은 마시멜로우가 손에 묻었어요. 끈적!", loss: 2 },
    { text: "지팡이에서 떨어져서 못 구웠어요.", loss: 2 },
    { text: "너무 가까이 대서 순식간에 탔어요!", loss: 3 },
    { text: "마법 불꽃이 꺼져버렸어요.", loss: 2 },
    { text: "마시멜로우를 너무 많이 먹어서 배탈났어요.", loss: 4 },
    { text: "로브에 마시멜로우가 묻어서 세탁해야 해요.", loss: 3 },
    { text: "친구가 제껴서 불에 떨어뜨렸어요!", loss: 3 },
    { text: "마시멜로우가 너무 딱딱해서 못 먹겠어요.", loss: 2 },
    { text: "주문 조절을 못해서 다 태웠어요.", loss: 4 },
    { text: "마시멜로우가 지팡이에 눌러붙었어요!", loss: 2 },
    ...
    { text: "지팡이 끝에 가시가 박혀서 손을 다쳤어요.", loss: 4 },
    { text: "너무 뜨거워서 입천장을 데었어요!", loss: 3 },
    { text: "마시멜로우가 폭발했어요! 주문 실수?", loss: 5 },
    { text: "다 구웠는데 피브즈가 가져갔어요!", loss: 4 }
  ]
