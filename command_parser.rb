...
module CommandParser
  ...
  def self.handle_tarot(mention, sender)
    ...
    lucky_items = ["마법지팡이", "깃털펜", "양피지", "가마솥", "빗자루", "마법약", "초콜릿 개구리", "버터맥주", "마법사 체스", "교과서", "망원경", "부엉이", "마법 거울", "시간 모래시계", "황금 스니치", "마법 열쇠", "갈레온", "편지", "온갖 맛이 나는 젤리빈", "감초 사탕", "피즈 위즈 팝", "드루블의엄청 잘 불어지는 풍선껌", "후추 도깨비", "아이스 마이스", "카나리아 크림", "1톤 혓바닥 토피", "트리클 타르트", "호박 파이"]
    lucky_places = ["도서관", "대강당", "그리핀도르 기숙사", "슬리데린 기숙사", "래번클로 기숙사", "후플푸프 기숙사", "변신술 교실", "마법약 교실", "점술 교실", "꿀듀크 과자가게", "스리 브룸스틱스", "올리밴더 지팡이 가게", "퀴디치 경기장", "해그리드 오두막", "온실", "요구의 방", "교장실", "의무실"]
